...
export default function CallToAction() {
  return (
    <section className="py-32 bg-[#f2ede7] relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[200px] rounded-full bg-[#c9922a]/6 blur-[80px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <AnimatedSection>
          ...
          <p className="text-[#777] text-lg mb-10 max-w-lg mx-auto">
